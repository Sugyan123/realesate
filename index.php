                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Engage in meaningful discussions with our experienced agents on Ghar Dekho.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Effortlessly manage and review essential documents with our file review feature</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Aquire, our cutting-edge acquisition tool, empowers you to seamlessly discover, evaluate.</p>
                        </div>
                    </div>
                </div>
            </div>
